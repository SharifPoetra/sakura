...
exports.run = async (client, msg, args) => {
	let user = msg.mentions.users.first() || client.users.get(args[1]);
...
async function getTriggered(triggered) {
  ...
  imgTitle.src = await get('https://raw.githubusercontent.com/kakakikikuku/apakaumauliat/master/assets/images/plate_triggered.png').then(x => x.body);
