...
exports.run = async (client, msg, args) => {
	...
	if(voiceChannel.id !== msg.member.voiceChannel.id) return msg.channel.send({ embed: { color: 0xf91d1d, description: `Woop I already playing in the other channel you must be in **${voiceChannel.name}** to request the song`}});	
